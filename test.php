...
<!--		<button id="axesToggle" type="button" onclick="toggleAxes()">Toggle Axes</button>
		...
		<form>
		    Vector Length:
		    <br/>
		    x1<input id="scaleLength" type="range" min="1" max="10" step="1" value="5" onchange="updateSpeedScale(this.value)">x10
		</form>
		<br/>
		<form>
		    Vector Height:
		    <br/>
		    x0.5<input id="scaleHeight" type="range" min="0.5" max="2" step="0.1" value="1.5" onchange="updateHeightScale(this.value)">x2
		</form>
		<br/>
		<form>
		    Vector Color:
		    <br/>
		    <input id="colorPicker" type="color" value="#cccc00" onchange="updateColor(this.value)">
		</form>
		 <div id="hexValue">#cccc00</div>
	    </div>
    ...
    $('#hexValue').html($('#colorPicker').value);
